...
If you are a Content Developer or a Software Developer or Software User, you must install {\bf\small Heterarch} on your local machine.\\
Currently, there are two types of {\bf \small Heterarch} installation:

\begin{enumerate}[noitemsep,nolistsep] 
\item[(A)] {\bf User:} Installation is a simple automated process that employs an installer package. The following installer packages are available:
\item[(B)] {\bf Developer}
\end{enumerate}
Typically, for each type of installation, once your machine is correctly configured and any missing \href{../heterarch-dependencies/heterarch-dependencies.tex}{\bf Heterarch Software Dependencies} are installed, the installation process is highly automated.

\subsection*{User Installation}

Installation is a simple automated process that employs an installer package.
